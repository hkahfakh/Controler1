package com.example.controler1.ui.gallery;
...
public class GalleryFragment extends Fragment {
    ...
    private class MyHandler extends android.os.Handler{
        ...
        MyHandler(GalleryFragment fragment){
            mFragment = new WeakReference<GalleryFragment>(fragment);
        }
    ...
    private void bindID(View root){
        btnStartClient = (Button) root.findViewById(R.id.btn_tcpClientConn);
        btnCloseClient = (Button) root.findViewById(R.id.btn_tcpClientClose);
        btnCleanClientRcv = (Button) root.findViewById(R.id.btn_tcpCleanClientRecv);
        btnCleanClientSend = (Button) root.findViewById(R.id.btn_tcpCleanClientSend);
        btnClientRandom = (Button) root.findViewById(R.id.btn_tcpClientRandomID);
        btnClientSend = (Button) root.findViewById(R.id.btn_tcpClientSend);
        editClientPort = (EditText) root.findViewById(R.id.edit_tcpClientPort);
        editClientIp = (EditText) root.findViewById(R.id.edit_tcpClientIp);
        editClientSend = (EditText) root.findViewById(R.id.edit_tcpClientSend);
        txtRcv = (TextView) root.findViewById(R.id.txt_ClientRcv);
        txtSend = (TextView) root.findViewById(R.id.txt_ClientSend);
    }
